#to be used with md5dict.txt as a word list
...
def main():
    ...
    if hash_cracked == "":
        print("\nFailed to crack. Try using a bigger/different word list")

if __name__  == "__main__":
    main()

##USAGE: python3 md5hash.py -md5 <your-hash-value-here> -w <your-dictionary-here>